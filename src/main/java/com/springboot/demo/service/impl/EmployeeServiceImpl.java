...
import com.springboot.demo.exception.RNotFoundException;
...
//            return employee.get();
//        }else{
//            throw new RNotFoundException("Employee", "Id", id);
//        }
        return employeeRepository.findById(id).orElseThrow(() -> new RNotFoundException("Employee", "Id",id));
    }

    @Override
    public Employee updateEmployee(Employee employee, long id) {
//        check whether employee with given id is existing database or not
        Employee existingEmployee = employeeRepository.findById(id).orElseThrow(() ->new RNotFoundException("Employee", "Id",id));
...
//        check whether employee exists or not
        employeeRepository.findById(id).orElseThrow(() ->new RNotFoundException("Employee", "Id",id));
